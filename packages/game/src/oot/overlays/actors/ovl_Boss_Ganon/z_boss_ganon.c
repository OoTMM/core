...
#include "oot/overlays/actors/ovl_En_Ganon_Mant/z_en_ganon_mant.h"
#include "oot/overlays/actors/ovl_En_Zl3/z_en_zl3.h"
#include "oot/overlays/actors/ovl_Bg_Ganon_Otyuka/z_bg_ganon_otyuka.h"
#include "oot/overlays/actors/ovl_En_Bom/z_en_bom.h"
