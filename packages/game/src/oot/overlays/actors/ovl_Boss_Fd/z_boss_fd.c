...
#include "oot/overlays/actors/ovl_En_Vb_Ball/z_en_vb_ball.h"
#include "oot/overlays/actors/ovl_Bg_Vb_Sima/z_bg_vb_sima.h"
#include "oot/overlays/actors/ovl_Boss_Fd2/z_boss_fd2.h"
